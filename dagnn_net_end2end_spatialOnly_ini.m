function nn = dagnn_net_end2end_spatialOnly_ini(varargin)

% init the object:
nn = dagnn.DagNN();
%------------Spatial Block1--------------------------------
c_cnv1 = dagnn.Conv('size',[5 5 3 32],'pad',2,'stride',1,'hasBias',true);
nn.addLayer('c_cnv1', c_cnv1, {'input'}, {'xc1_1'},{'c1','b1'}); % output dim = 30-6 = 24
...
nn.addLayer('dropout1', dagnn.DropOut('rate', 0.2), {'xc4_1'}, {'dp1'}); 
...
nn.addLayer('dropout2', dagnn.DropOut('rate', 0.2), {'xc8_1'}, {'dp2'}); 
...
c_fc1 = dagnn.Conv('size',[4 4 128 256],'pad',0,'stride',1,'hasBias',true);
nn.addLayer('c_fc1', c_fc1, {'xc12_1'}, {'xc13_1'},{'c4','b4'});
nn.addLayer('c_re4', dagnn.ReLU(), {'xc13_1'}, {'xc14_1'});
nn.addLayer('dropout5', dagnn.DropOut('rate', 0.5), {'xc14_1'}, {'dp5'}); 
% %------------Temporal Block1--------------------------------
...
% nn.addLayer('concatenation', dagnn.Concat('dim', 3), {'xc14_1', 'xc14_2'}, {'concate'}); 
% f_fcc = dagnn.Conv('size', [1,1,128,1024],'pad',0,'stride',1,'hasBias',true);
% nn.addLayer('f_fcc',f_fcc, {'concate'}, {'conv1'},{'s','t'}); 
