function nn = dagnn_net_end2end_fc1fuse_sum_ini(varargin)
% Author: Jiawei Chen
% Two stream ConvNet fused after first fully-connected layer using sum fusion 
...
nn.addLayer('Sum', dagnn.Sum(), {'xc14_1', 'xc14_2'}, {'sum_fc1'}); 
nn.addLayer('dropout5', dagnn.DropOut('rate', 0.5), {'sum_fc1'}, {'dp5'}); 
